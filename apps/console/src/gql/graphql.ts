...
export type UserLoaderQueryQueryVariables = Exact<{ [key: string]: never }>;

export type UserLoaderQueryQuery = {
  __typename: 'Query';
...
export const UserLoaderQueryDocument = {
  __meta__: { hash: '4b2a74ae32003331a34e0ea8bd2eae89cb5f36ee' },
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'UserLoaderQuery' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
...
} as unknown as DocumentNode<UserLoaderQueryQuery, UserLoaderQueryQueryVariables>;
